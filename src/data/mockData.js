...
const JAVA_BEGINNER_CONTENT = {
    ...
    public static void main(String[] args) {
        ...
        `,
        questions: [
            { id: 1, type: 'practice', prompt: 'Print â€œHello, EduCodeâ€ on one line and your name on the next.', template: 'class Main { public static void main(String[] args){ /* write here */ } }', solution: 'System.out.println' },
            ...
            { id: 3, type: 'modify', prompt: 'Change message to â€œLearning Java!â€ and add another line â€œDay 1â€.', template: 'class Main { public static void main(String[] args){ System.out.println("Start"); } }', solution: 'Learning Java!' },
...
java Main</code></pre>
        ...
        `,
        questions: [
            { id: 1, type: 'practice', prompt: 'Print â€œSetup OKâ€.', template: 'class Main { public static void main(String[] args){ /* print */ } }', solution: 'Setup OK' },
            ...
            { id: 4, type: 'fix', prompt: 'Fix class name case: class main â†’ class Main', template: 'class main { public static void main(String[] args){ System.out.println("Hi"); } }', solution: 'class Main' },
    ...
    "Java Program Structure": {
        ...
        `,
        questions: [
            { id: 1, type: 'practice', prompt: 'Print â€œStructure OKâ€.', template: 'class Main { public static void main(String[] args){ /* print */ } }', solution: 'Structure OK' },
            ...
            { id: 3, type: 'modify', prompt: 'Add a third print â€œZâ€.', template: 'class Main { public static void main(String[] args){ System.out.println("X"); System.out.println("Y"); } }', solution: 'Z' },
    ...
    "Variables": {
        ...
        questions: [
            ...
            { id: 4, type: 'fix', prompt: 'Fix type: int val = "5" â†’ 5.', template: 'class Main { public static void main(String[] args){ int val = "5"; System.out.println(val); } }', solution: 'int val = 5' },
            { id: 5, type: 'logic', prompt: 'Store item and price; print â€œItem: name, Price: priceâ€.', template: 'class Main { public static void main(String[] args){ String name="Pen"; double price=10.5; /* print */ } }', solution: 'Item:' }
        ]
    },
    "Primitive Data Types": {
        ...
        questions: [
            ...
            { id: 4, type: 'fix', prompt: 'Fix float f = 2.0 â†’ 2.0f.', template: 'class Main { public static void main(String[] args){ float f = 2.0; System.out.println(f); } }', solution: '2.0f' },
    ...
    "Operators": {
        ...
        questions: [
            ...
            { id: 4, type: 'fix', prompt: 'Fix: int k += 1; â†’ declare k and then k += 1;', template: 'class Main { public static void main(String[] args){ int k += 1; System.out.println(k); } }', solution: 'int k=0;' },
    ...
    "Arrays": {
        ...
        questions: [
            ...
            { id: 3, type: 'modify', prompt: 'Change second city to â€œCoimbatoreâ€ and print all.', template: 'class Main { public static void main(String[] args){ String[] cities={"Chennai","Madurai"}; /* change+print */ } }', solution: 'Coimbatore' },
            { id: 4, type: 'fix', prompt: 'Fix index: a[3]=10 â†’ a[2]=10 for size 3.', template: 'class Main { public static void main(String[] args){ int[] a = new int[3]; a[3]=10; System.out.println(a[2]); } }', solution: 'a[2]' },
    ...
    "Methods": {
        ...
        `,
        questions: [
            { id: 1, type: 'practice', prompt: 'Method greet(String n) returns â€œHello, nâ€.', template: 'class Main { static String greet(String n){ /* return */ } public static void main(String[] a){ System.out.println(greet("Asha")); } }', solution: 'return "Hello, "' },
...
const JAVA_INTERMEDIATE_CONTENT = {
    ...
    public static void main(String[] a){ new Intro().say(); }
        ...
        `,
        questions: [
            { id: 1, type: 'practice', prompt: 'Write a class Hello with method greet() printing â€œOOPSâ€.', template: 'class Hello { /* method */ } class Main { public static void main(String[] a){ /* call */ } }', solution: 'void greet' },
            ...
            { id: 3, type: 'modify', prompt: 'Add a second method info() printing â€œFour pillarsâ€.', template: 'class Intro { void say(){ System.out.println("OOPS"); } }', solution: 'info' },
...
class Main { public static void main(String[] a){ Account acc=new Account(100); System.out.println(acc.balance); } }</code></pre>
        ...
        questions: [
            ...
            { id: 4, type: 'fix', prompt: 'Fix wrong constructor name: void Wallet(){...} â†’ Wallet(){...}.', template: 'class Wallet { void Wallet(){ } }', solution: 'Wallet()' },
...
class Main { public static void main(String[] a){ new Dog().speak(); } }</code></pre>
        `,
        questions: [
            { id: 1, type: 'practice', prompt: 'Create Bike extends Vehicle; print â€œBike movingâ€.', template: 'class Vehicle { void move(){ System.out.println("Moving"); } } /* child */', solution: 'extends Vehicle' },
...
class J { public static void main(String[] a) throws Exception { /* Connection conn=DriverManager.getConnection(url,user,pw); */ }
        ...
        questions: [
            ...
            { id: 5, type: 'logic', prompt: 'Print â€œConnectedâ€ when connection is not null (commented).', template: 'import java.sql.*; class M{ public static void main(String[] a){ /* connect */ } }', solution: 'Connected' }
        ]
    }
};
...
print(f"Hello, {name}!")</code></pre>`,
        questions: [
            ...
            { id: 4, type: 'fix', prompt: 'Fix syntax error: print"Hello" â†’ print("Hello")', template: 'print"Hello"', solution: 'print("Hello")' },
...
while count < 3:
    ...
    "Functions â€“ Basics": {
        content: `<h3>Functions â€“ Basics</h3>
...
â””â”€â”€ requirements.txt</code></pre>`,
        questions: [
            ...
            { id: 5, type: 'logic', prompt: 'Create main loop: menu â†’ action â†’ save.', template: 'while True:\n    choice = input()\n    if choice == "1":\n        # add task', solution: 'if' }
        ]
    }
};
...
for animal in [Dog(), Cat()]:
    print(animal.speak())</code></pre>`,
        questions: [
            ...
            { id: 5, type: 'logic', prompt: 'Create hierarchy: Employee (parent) â†’ Manager, Developer.', template: 'class Employee:\n    def __init__(self, name):', solution: 'class Manager(Employee)' }
        ]
    },
...
â””â”€â”€ README.md</code></pre>`,
        questions: [
            ...
            { id: 5, type: 'logic', prompt: 'Create pipeline: scrape â†’ parse â†’ store â†’ serve.', template: '# Plan steps\n1. Scrape\n2. Parse\n3. Store\n4. Serve', solution: 'scrape' }
        ]
    }
};
